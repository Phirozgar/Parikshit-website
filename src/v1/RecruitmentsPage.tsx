      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#111111] rounded-xl shadow-lg border border-[#7AECEC]/20 p-8 mb-8">
          ...
          <p className="text-[#7AECEC]/80 mb-4">
            We welcome passionate students from all branches and years who are interested in space technology, engineering, research, and innovation. No prior experience is required—just curiosity and commitment!
          </p>
        </div>
        <div className="bg-[#0A0A0A] rounded-xl shadow border border-[#7AECEC]/10 p-8 mb-8">
          ...
          <ol className="list-decimal list-inside text-[#7AECEC]/80 space-y-2">
            <li><span className="font-semibold text-[#7AECEC]">Applications Open:</span> At the start of each semester (watch our socials for announcements).</li>
            <li><span className="font-semibold text-[#7AECEC]">Written Application:</span> Fill out the online form with your interests, background, and motivation.</li>
            <li><span className="font-semibold text-[#7AECEC]">Shortlisting:</span> Applications are reviewed by the team leads.</li>
            <li><span className="font-semibold text-[#7AECEC]">Interviews:</span> Shortlisted candidates are invited for interviews (technical and HR).</li>
            <li><span className="font-semibold text-[#7AECEC]">Results:</span> Selected candidates are notified via email and added to the team!</li>
          </ol>
        </div>
        ...
        <div className="bg-[#0A0A0A] rounded-xl shadow border border-[#7AECEC]/10 p-8">
          ...
          <p className="text-[#7AECEC]/80 mb-2">For queries, email us at <a href="mailto:parikshit@university.edu" className="underline text-[#7AECEC]">parikshit@university.edu</a> or follow us on our social media for the latest updates on recruitments.</p>
        </div>
      </div>
    </div>
  );
