      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {projects.map((project) => (
            ...
            >
              {/* Tech corner accents */}
              <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-[#7AECEC]/40 z-10"></div>
              <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-[#7AECEC]/40 z-10"></div>
              <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-[#7AECEC]/40 z-10"></div>
              <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-[#7AECEC]/40 z-10"></div>
              ...
              <div className="relative h-96 rounded-lg overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-8">
                  <div className="w-16 h-px bg-gradient-to-r from-transparent via-[#7AECEC] to-transparent mb-4"></div>
                  <h3 className="text-3xl font-bold text-white mb-2">
                    {project.title}
                  </h3>
                  <p className="text-[#7AECEC] text-sm font-mono uppercase tracking-wider">
                    {project.subtitle}
                  </p>
                  <div className="w-16 h-px bg-gradient-to-r from-transparent via-[#7AECEC] to-transparent mt-4"></div>
                </div>

                {/* Hover overlay - slides up from bottom */}
                <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-black via-black/98 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-out flex flex-col justify-end p-6">
                  <div className="mb-3">
                    ...
                    <div className="space-y-2">
                      {project.details.map((detail, index) => (
                        <div key={index} className="flex items-start text-gray-300 text-sm">
                          <div className="w-1.5 h-1.5 bg-[#7AECEC] rounded-full mr-2 mt-1.5"></div>
                          <span>{detail}</span>
                        </div>
                      ))}
                    </div>
        ...
        <AnimatePresence>
          {activeProject && (
            ...
            >
              <motion.div
                className="bg-gradient-to-br from-[#0A0A0A] via-[#0d1117] to-[#0A0A0A] max-w-5xl w-full rounded-xl border border-[#7AECEC]/60 shadow-2xl shadow-[#7AECEC]/20 relative overflow-hidden"
              ...
              >
                {/* Tech corner accents */}
                <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-[#7AECEC]/40"></div>
                <div className="absolute top-0 right-0 w-20 h-20 border-t-2 border-r-2 border-[#7AECEC]/40"></div>
                <div className="absolute bottom-0 left-0 w-20 h-20 border-b-2 border-l-2 border-[#7AECEC]/40"></div>
                <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-[#7AECEC]/40"></div>
                ...
                <button
                  onClick={() => setActiveProject(null)}
                  className="absolute top-6 right-6 z-10 text-gray-400 hover:text-[#7AECEC] transition-colors duration-200 w-10 h-10 flex items-center justify-center rounded border border-[#7AECEC]/30 hover:border-[#7AECEC] hover:bg-[#7AECEC]/10 backdrop-blur-sm bg-black/50"
                >
                ...
                <div className="relative flex flex-col md:flex-row">
                  ...
                  <div className="md:w-2/5 relative">
                    ...
                    <img
                      ...
                      className="w-full h-full min-h-[500px] object-cover border-r-2 border-[#7AECEC]/30"
                    />
                  ...
                  {/* RIGHT SIDE - Content */}
                  <div className="md:w-3/5 p-8 overflow-y-auto max-h-[600px]">
                    {/* Project Header */}
                    <div className="mb-6">
                      <div className="flex items-center gap-2 mb-3">
                    ...
                    {/* Mission Brief */}
                    <div className="mb-6 p-4 bg-gradient-to-r from-[#7AECEC]/5 to-transparent border-l-2 border-[#7AECEC]/50">
                    ...
                    <div className="border border-[#7AECEC]/20 rounded-lg bg-gradient-to-br from-[#7AECEC]/5 to-transparent p-5 backdrop-blur-sm">
                      ...
                      <div className="space-y-3">
                        {activeProject.details.map((d, i) => (
                          <div key={i} className="flex items-start group">
                            <div className="mt-1.5 mr-3 w-1.5 h-1.5 bg-[#7AECEC] rounded-full group-hover:scale-150 transition-transform"></div>
